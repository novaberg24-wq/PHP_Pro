...
<head>
    <meta charset="UTF-8"/>
    <title>Pritiselfdrivecar - Ultimate Booking System</title>
            ...
            <div class="row">
                <div class="col-xs-3">
                    <h1><a target="_blank" href="{{url('intro')}}"><img src="{{url('images')}}/logo.svg"
                                                                 alt="Pritiselfdrivecar Logo"/></a></h1>
                </div>
                <div class="col-xs-9">
...
<!--<img src="<?php /*echo $url . '/img/footer-corrner.png'; */?>" class="footer-corrner"/>-->
    <div class="container">
        <h3>Creating your own Booking<br />System with <span>Pritiselfdrivecar</span> is super<br />fast and easy <img src="{{url('landing/img/hand.svg')}}" /></h3>
