...
<a href="mailto:contact@bookingcore.test">contact@bookingcore.test</a>',
                ...
                [
                    ...
                    'val'   => 'Copyright © 2019 by Pritiselfdrivecar',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    'val' => "<!DOCTYPE html><html><head></head><body><h3>Pritiselfdrivecar</h3><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>Tell. + 00 222 444 33</p><p>Email. hello@yoursite.com</p><p>1355 Market St, Suite 900San, Francisco, CA 94103 United States</p></body></html>",
                    'group' => "general",
                ],
                [
...
<p>This document was last updated on October 6, 2020</p>';
        ...
        $settings = [
                ...
                [
                    'name'  => "email_header",
                    'val'   => '<h1 class="site-title" style="text-align: center">Pritiselfdrivecar</h1>',
                    'group' => "general",
                ],
                [
                    'name'  => "email_footer",
                    'val'   => '<p class="" style="text-align: center">&copy; 2019 Pritiselfdrivecar. All rights reserved</p>',
                    'group' => "general",
                ],
                [
                ...
                [
                    ...
                    <p>Thank you for signing up with Pritiselfdrivecar! We hope you enjoy your time with us.</p>
                    <p>Regards,</p>
                    <p>Pritiselfdrivecar</p>',
                    'group' => "user",
                ],
                [
            ...
            [
                ...
                [
                    ...
                    'val'   => "<p><span style=\"font-size: 14pt;\"><strong>Pritiselfdrivecar Company</strong></span></p>
                                <p>Ha Noi, Viet Nam</p>
