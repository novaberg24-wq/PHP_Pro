...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Pritiselfdrivecar'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Pritiselfdrivecar by')}} <a href="{{__('https://v4inspire.tech')}}" target="_blank">{{__('V4inspire Team')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://v4inspire.tech')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://v4inspire.tech')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
