                                ...
                                <div class="col-md-4 d-none">
                                    <div class="area-setting-item">
                                        ...
                                        <span class="setting-item-media">
                                            ...
                                            <span class="setting-item-desc">{{__("Updater Pritiselfdrivecar")}}</span>
                                        </span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="area-setting-item">
                                        ...
                                        <span class="setting-item-media">
                                            ...
                                            <span class="setting-item-desc">{{__("Plugins for Pritiselfdrivecar")}}</span>
                                        </span>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="area-setting-item">
                                        ...
                                        <span class="setting-item-media">
                                            ...
                                            <span class="setting-item-desc">{{__("Clear Cache for Pritiselfdrivecar")}}</span>
                                        </span>
                                        </a>
                                    </div>
                                </div>
