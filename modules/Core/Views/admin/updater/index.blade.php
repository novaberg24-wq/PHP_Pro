    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                @if($ready_for_update)
                <div class="panel">
                    <div class="panel-title"><strong>{{__('Update Pritiselfdrivecar')}}</strong></div>
                    <div class="panel-body">
                            ...
                            @if($updater_latest_version = setting_item('updater_latest_version') and version_compare(config('app.version'),$updater_latest_version,'='))
                                <p class="alert-success alert"><strong>{{__("You are using newest version of Pritiselfdrivecar: :version",['version'=>$updater_latest_version])}}</strong></p>
                            @endif
